...
?>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            if ($list[$i]['is_notice']) // 공지사항
                echo '<strong class="notice_icon"><i class="fa fa-bullhorn" aria-hidden="true" title="공지"></i><span class="sound_only">공지</span></strong>';
            else if ($wr_id == $list[$i]['wr_id'])
                // echo "<span class=\"bo_current\">열람중</span>";
                echo "<strong class=\"bo_current\">".$list[$i]['num']."</strong>";
            else
                echo $list[$i]['num'];
             ?>
            </td>
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <?php } ?>
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="bo_subject_link">
                    ...
                    ?>
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="bo_cnt_cmt"><?php echo $list[$i]['wr_comment']; ?></span><span class="sound_only">개</span><?php } ?>
                    </a>
                </div>
    ...
    <fieldset id="bo_sch">
        ...
        <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" maxlength="20" placeholder="검색어">
