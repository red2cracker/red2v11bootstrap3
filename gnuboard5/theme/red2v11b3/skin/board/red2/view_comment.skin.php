...
<!-- <button type="button" class="cmt_btn" id="cmt_list"><i class="fa fa-commenting-o" aria-hidden="true"></i> 댓글목록</button> -->
<!-- 댓글 시작 { -->
<section id="bo_vc">
    <h2>댓글목록</h2>
    <?php
    ...
    <article id="c_<?php echo $comment_id ?>con" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header style="z-index:<?php echo $cmt_sv; ?>">
            <span class="bo_vc_symbol_target" id="c_<?php echo $comment_id ?>">&nbsp;</span>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
            ...
            <input type="submit" id="btn_submit" class="btn_submit" value="댓글">
        </div>
    </div>
    </form>
</aside>
