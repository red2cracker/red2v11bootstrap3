...
<input type="hidden" name="mb_mailling" value="">
<input type="hidden" name="mb_sms" value="">
...
<?php }  ?>
 <div id="register_form"  class="form_01">
    <h1 class="register_form_title"><?php echo $w==''?'회원가입':'정보수정'; ?></h1>

    <div>
        <h2 class="sound_only">사이트 이용정보 입력</h2>
        <ul>
            <li>
                <label for="reg_mb_id">아이디 <strong>(필수)</strong></label>
            ...
            <li>
                <label for="reg_mb_password">비밀번호 <strong>(필수)</strong></label>
            ...
            <li>
                <label for="reg_mb_password_re">비밀번호 확인 <strong>(필수)</strong></label>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            <?php if ($req_nick) {  ?>
            <li>
                <label for="reg_mb_nick">닉네임 <strong>(필수)</strong></label>
            ...
            <li>
                <label for="reg_mb_email">이메일<strong> (필수)</strong></label>
                ...
                <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input half_input email required" size="70" maxlength="100" placeholder="이메일">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            ...
            <li class="is_captcha_use">
                <label for="reg_mb_captcha">자동등록방지<strong> (필수)</strong></label>
