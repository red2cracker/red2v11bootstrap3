    ...
    <fieldset>
        <div class="ol_wr">
			...
			<div class="ol_id_wr">
                ...
                <input type="text" id="ol_id" name="mb_id" required maxlength="20" placeholder="아이디" title="아이디를 입력하세요 (필수)">
			</div>

			<div class="ol_pw_wr">
                <label for="ol_pw" id="ol_pwlabel" class="sound_only">비밀번호<strong>필수</strong></label>
                <input type="password" name="mb_password" id="ol_pw" required maxlength="20" placeholder="비밀번호" title="비밀번호를 입력하세요 (필수)">
			</div>
			
            <div class="ol_submit_wr">
